...
public class Map : MonoBehaviour
{
    ...
    public void MoveToTarget()
    {
        ...
        {
            Debug.Log("Connected!");
            GameObject.FindGameObjectWithTag("ConnectedDisplay").GetComponent<RectTransform>().localPosition = new Vector3(icons[self_index].GetComponent<RectTransform>().localPosition.x, icons[self_index].GetComponent<RectTransform>().localPosition.y + 60f, -0.01f);
